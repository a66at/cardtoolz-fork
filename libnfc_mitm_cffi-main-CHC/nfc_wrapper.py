...
class NfcTargetCloudEmul(): # this is Emulator

        #super().__init__(devdesc, verbosity)
    #    self._device_name = "CloudEmulator"
    #    ret = 0
    ...
    def __init__(self):
        ...
        ret = 0 #nfc.nfc_target_init(self._device, targettype, self._rxbytes, MAX_FRAME_LEN, timeout)
        #self.last_err = ret
